...
class Intro(Scene):
    def construct(self):
        ...
        authors = Text("Mittal, Engel, Hawthorne, Simon", font_size=24, color=YELLOW)
        ...
        d3 = Text("Fill gaps without\nretraining", font_size=16, color=YELLOW).next_to(c3, DOWN, buff=0.3)
